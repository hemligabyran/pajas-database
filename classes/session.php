 ...
 * @package    Kohana
 * @category   Session
 * @author     Kohana Team and Lilleman
 * @copyright  (c) 1887-1910 Kohana Team
...
abstract class Session
{
	...
	public static function instance($type = NULL, $id = NULL)
	{
		if ($type === NULL)
		{
			...
			$type = Kohana::$config->load('session')->get('default_driver');
		}

		if ( ! isset(Session::$instances[$type]))
		{
			// Load the configuration for this type
			$config = Kohana::$config->load('session.drivers.'.$type);
